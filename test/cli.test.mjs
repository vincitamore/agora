...
test("cli: every watch ends with one watch-result line, on stderr in human output and on stdout under --json", async () => {
  ...
  try {
    ...
    assert.deepEqual(quiet, { type: "watch-result", room: "down", alias: "down", session: "w", bearer: "Grace", fired: false, delivered: 0, skipped: 0, filtered: 0, polls: 1, budgetSeconds: 0, cursor: null, threads: {}, evicted: [], following: 0, exit: 0 });
