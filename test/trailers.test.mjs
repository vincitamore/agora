...
test("an address matches a bearer by whole segments, from the left", () => {
  ...
  assert.equal(matchesAddress("example_bot", "Alice/watch", seat), true, "the seat's own name reaches whoever holds it");
  assert.equal(matchesAddress("example_bot", "Alice/watch", undefined), false);
});
