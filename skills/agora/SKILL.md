...
fitting limit named by the host and reports every omitted older row with a frame-fit first recovery
page; repeat from that page's last cursor until the omitted window is reached.
