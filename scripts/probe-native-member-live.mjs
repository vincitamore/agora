...
// Fable runs it after T2 freezes. It must exhibit Tailcat's own --allow refusal and
...
throw new Error("live T3 probe is a Fable-operated harness; supply the real-machine adapter and explicit descriptor paths before running it");
